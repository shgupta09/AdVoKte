...
- (instancetype)init
{
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(recieveNotification:) name:@"LoadNextMonth" object:nil];
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(recieveNotification:) name:@"LoadPreviousMonth" object:nil];
...
-(void) recieveNotification:(NSNotification*) notification {
    ...
    if ([[notification name] isEqualToString:@"LoadNextMonth"]) {
        self.contentView.contentOffset = CGPointMake(640, 0);
        [self updatePage];
    }
    else if([[notification name] isEqualToString:@"LoadPreviousMonth"])
    {
